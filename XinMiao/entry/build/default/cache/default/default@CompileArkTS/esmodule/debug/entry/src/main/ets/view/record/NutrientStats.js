...
export default class NutrientStats extends ViewPU {
    ...
    initialRender() {
        ...
        this.StatsBuilder.bind(this)(makeBuilderParameterProxy("StatsBuilder", { label: () => '碳水化合物', value: () => (this["__carbon"] ? this["__carbon"] : this["carbon"]), recommend: () => (this["__recommendCarbon"] ? this["__recommendCarbon"] : this["recommendCarbon"]), color: () => ({ "id": 16777291, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }) }));
        this.StatsBuilder.bind(this)(makeBuilderParameterProxy("StatsBuilder", { label: () => '蛋白质', value: () => (this["__protein"] ? this["__protein"] : this["protein"]), recommend: () => (this["__recommendProtein"] ? this["__recommendProtein"] : this["recommendProtein"]), color: () => ({ "id": 16777309, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }) }));
        this.StatsBuilder.bind(this)(makeBuilderParameterProxy("StatsBuilder", { label: () => '脂肪', value: () => (this["__fat"] ? this["__fat"] : this["fat"]), recommend: () => (this["__recommendFat"] ? this["__recommendFat"] : this["recommendFat"]), color: () => ({ "id": 16777292, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }) }));
        Row.pop();
    }
