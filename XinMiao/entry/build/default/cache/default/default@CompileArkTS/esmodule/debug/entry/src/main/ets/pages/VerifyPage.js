...
function __Text__promptTextStyle() {
    ...
    Text.padding({
        ...
        right: { "id": 16777369, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }
    });
}
class VerifyPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.__verifyItem = new ObservedPropertyObjectPU(new VerifyItem({ "id": 16777444, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, 'XYZK'), this, "verifyItem");
    ...
    initialRender() {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.padding({
                ...
                right: { "id": 16777364, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.height({ "id": 16777366, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Image.width({ "id": 16777367, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777231, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Text.fontColor({ "id": 16777300, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Text.fontSize({ "id": 16777319, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Text.width({ "id": 16777365, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            TextInput.create({ placeholder: { "id": 16777284, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, text: this.inputText });
            ...
            TextInput.height({ "id": 16777344, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            TextInput.margin({
                left: { "id": 16777369, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" },
                right: { "id": 16777369, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" },
                top: { "id": 16777370, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" },
                bottom: { "id": 16777370, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            if (this.isInputWrong) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create({ "id": 16777286, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
                        Text.fontColor({ "id": 16777315, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create({ "id": 16777283, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create({ "id": 16777285, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Text.fontSize({ "id": 16777319, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Text.fontColor({ "id": 16777300, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Text.margin({
                top: { "id": 16777368, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" },
                bottom: { "id": 16777368, "type": 10002, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }
            });
            Text.onClick(() => {
