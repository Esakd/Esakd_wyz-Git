...
class TaskList extends ViewPU {
                ...
                const mission = _item;
                {
                    ...
                    const observedDeepRender = () => {
                        ...
                        this.observeComponentCreation((elmtId, isInitialRender) => {
                            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                            TextInput.create({
                                placeholder: { "id": 16777258, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" } //text:
                            });
    ...
    DeleteButton(index, parent = null) {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777382, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
