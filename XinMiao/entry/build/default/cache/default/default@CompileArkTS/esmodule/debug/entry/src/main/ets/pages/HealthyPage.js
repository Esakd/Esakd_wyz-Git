...
class Index extends ViewPU {
    ...
    selectColor(index) {
        return this.currentIndex === index ? { "id": 16777308, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" } : { "id": 16777293, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" };
    }
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBarBuilder.call(this, { "id": 16777276, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, { "id": 16777410, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, 0);
                } });
            if (!isInitialRender) {
                TabContent.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBarBuilder.call(this, { "id": 16777275, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, { "id": 16777383, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, 1);
                } });
            if (!isInitialRender) {
                TabContent.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            TabContent.tabBar({ builder: () => {
                    this.TabBarBuilder.call(this, { "id": 16777277, "type": 10003, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, { "id": 16777443, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, 2);
                } });
            if (!isInitialRender) {
                TabContent.pop();
            }
