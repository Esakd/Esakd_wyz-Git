export default class DatePickDialog extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("view/record/DatePickDialog.ets(6:5)");
            Column.padding(12);
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            DatePicker.debugLine("view/record/DatePickDialog.ets(8:7)");
            // 1.日期选择器
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 2.按钮
            Row.create({ space: 12 });
            Row.debugLine("view/record/DatePickDialog.ets(17:7)");
            if (!isInitialRender) {
                // 2.按钮
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("view/record/DatePickDialog.ets(18:9)");
            Button.width(120);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("view/record/DatePickDialog.ets(22:9)");
            Button.width(120);
