...
import { GlobalContext } from '@bundle:com.example.XinMiao/entry/ets/common/utils/GlobalContext';
/**
...
export default class WindowModel {
     ...
     */
    static getInstance() {
        let instance = GlobalContext.getContext().getObject('windowModel');
    ...
    createSubWindow() {
        ...
        this.windowStage.createSubWindow(CommonConstants.SUB_WINDOW_NAME, (err, data) => {
            if (err.code) {
