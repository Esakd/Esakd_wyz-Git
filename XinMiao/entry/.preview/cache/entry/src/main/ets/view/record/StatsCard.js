...
export default class StatsCard extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("view/record/StatsCard.ets(29:5)");
            Column.width(CommonConstants_health.THOUSANDTH_940);
            Column.backgroundColor({ "id": 16777245, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 1.日期信息
            Row.create();
            Row.debugLine("view/record/StatsCard.ets(31:7)");
            // 1.日期信息
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("view/record/StatsCard.ets(32:9)");
            Text.fontColor({ "id": 16777243, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create({ "id": 16777307, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            Image.debugLine("view/record/StatsCard.ets(34:9)");
            Image.width(20);
            Image.fillColor({ "id": 16777243, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            if (!isInitialRender) {
                Image.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 2.统计信息
            Swiper.create();
            Swiper.debugLine("view/record/StatsCard.ets(42:7)");
            // 2.统计信息
            Swiper.width('100%');
            // 2.统计信息
            ...
            // 2.统计信息
            Swiper.indicatorStyle({ selectedColor: { "id": 16777241, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" } });
            // 2.统计信息
