...
function PointAppearance(point, parent = null) {
    (parent ? parent : this).observeComponentCreation((elmtId, isInitialRender) => {
        ...
        Row.create();
        Row.debugLine("pages/GamePage.ets(17:3)");
        if (!isInitialRender) {
            Row.pop();
        }
        ...
        if (!point.appearance) {
            (parent ? parent : this).ifElseBranchUpdateFunction(0, () => {
                (parent ? parent : this).observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    Image.debugLine("pages/GamePage.ets(19:7)");
...
class AnimationPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.__src = new ObservedPropertyObjectPU({ "id": 16777318, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" }, this, "src");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/GamePage.ets(72:5)");
            Row.height('100%');
            Row.width('100%');
            Row.backgroundImage({ "id": 16777300, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Stack.create();
            Stack.debugLine("pages/GamePage.ets(73:7)");
            Stack.height('100%');
            Stack.width('100%');
            if (!isInitialRender) {
                Stack.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Button.debugLine("pages/GamePage.ets(74:9)");
            ...
            if (!this.isEntry) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Text.create('恭喜你, 球进了！');
                        Text.debugLine("pages/GamePage.ets(82:11)");
            ...
            if (!this.isBegin) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("pages/GamePage.ets(89:11)");
                        // 开始按钮
                        Button.onClick(() => {
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("pages/GamePage.ets(99:11)");
                    ...
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                        Image.create({ "id": 16777414, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
                        Image.debugLine("pages/GamePage.ets(109:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 摇杆
            Row.create();
            Row.debugLine("pages/GamePage.ets(116:9)");
            // 摇杆
            Row.height(600);
            // 摇杆
            Row.width(150);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Circle.debugLine("pages/GamePage.ets(117:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Circle.debugLine("pages/GamePage.ets(120:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/GamePage.ets(129:9)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
            ...
            case TouchType.Move:
                ...
                Context.animateTo({ curve: curves.responsiveSpringMotion() }, () => {
                    ...
                    if (Math.abs(angle * 2) < Math.PI) {
                        this.src = { "id": 16777318, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" };
                    }
                    else {
                        this.src = { "id": 16777318, "type": 20000, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" };
