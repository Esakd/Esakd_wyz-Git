...
export default class CalorieStats extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.debugLine("view/record/CalorieStats.ets(13:5)");
            Row.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 2.还可以吃
            Stack.create();
            Stack.debugLine("view/record/CalorieStats.ets(17:7)");
            if (!isInitialRender) {
                // 2.还可以吃
                Stack.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Progress.debugLine("view/record/CalorieStats.ets(19:9)");
            // 2.1.进度条
            Progress.width(120);
            // 2.1.进度条
            Progress.style({ strokeWidth: CommonConstants_health.DEFAULT_10 });
            // 2.1.进度条
            Progress.color({ "id": 16777241, "type": 10001, params: [], "bundleName": "com.example.XinMiao", "moduleName": "entry" });
            if (!isInitialRender) {
                // 2.1.进度条
                Progress.pop();
            }
    ...
    StatsBuilder($$, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("view/record/CalorieStats.ets(39:5)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('还需运动');
            Text.debugLine("view/record/CalorieStats.ets(40:7)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('5000' + ' 步');
            Text.debugLine("view/record/CalorieStats.ets(43:7)");
            Text.fontSize(20);
            ...
            if ($$.tips) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("view/record/CalorieStats.ets(47:9)");
                        Text.fontSize(12);
