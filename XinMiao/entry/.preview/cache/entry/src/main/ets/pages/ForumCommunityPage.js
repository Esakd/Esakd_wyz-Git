...
class ForumPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.debugLine("pages/ForumCommunityPage.ets(19:5)");
            Column.width('100%');
            Column.height('100%');
            Column.padding(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/ForumCommunityPage.ets(23:7)");
            List.width('100%');
            List.layoutWeight(1);
            List.onReachEnd(() => {
            ...
            const forEachItemGenFunction = _item => {
                const forum = _item;
                {
                    ...
                    const itemCreation = (elmtId, isInitialRender) => {
                        ...
                        ListItem.debugLine("pages/ForumCommunityPage.ets(25:11)");
                        if (!isInitialRender) {
                            ListItem.pop();
                        }
                        ViewStackProcessor.StopGetAccessRecording();
