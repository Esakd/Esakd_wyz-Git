...
class Index extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/PhotoPage.ets(12:5)");
            Row.height('100%');
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/PhotoPage.ets(13:7)");
            Column.width('100%');
            Column.height('100%');
            if (!isInitialRender) {
                Column.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('选择图片');
            Text.debugLine("pages/PhotoPage.ets(14:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('选择文件');
            Text.debugLine("pages/PhotoPage.ets(25:9)");
            Text.textAlign(TextAlign.Center);
            Text.width(200);
            Text.fontSize(16);
            Text.padding(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('拍照');
            Text.debugLine("pages/PhotoPage.ets(36:9)");
            Text.textAlign(TextAlign.Center);
            Text.width(200);
            Text.fontSize(16);
            Text.padding(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/PhotoPage.ets(47:9)");
            Divider.width('100%');
            Divider.height(0.5);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/PhotoPage.ets(54:9)");
            Text.textAlign(TextAlign.Center);
            Text.width('100%');
            Text.fontSize(16);
            Text.margin(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/PhotoPage.ets(60:9)");
            Text.textAlign(TextAlign.Center);
            Text.width('100%');
            Text.fontSize(16);
            Text.margin(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/PhotoPage.ets(66:9)");
            Text.textAlign(TextAlign.Center);
            Text.width('100%');
            Text.fontSize(16);
            Text.margin(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/PhotoPage.ets(72:9)");
            Text.textAlign(TextAlign.Center);
            Text.width('100%');
            Text.fontSize(16);
            Text.margin(10);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Image.debugLine("pages/PhotoPage.ets(78:9)");
            Image.width(300);
            Image.height(300);
